...
/**
 * Replaces symbols in a given string using either main or fallback symbols based on a flag.
 *
 ...
 * @param {boolean} [options.useFallback=false] - Flag indicating whether to use fallback symbols. If true, main symbols are replaced with their corresponding fallbacks.
 * @returns {string} - The input string with symbols replaced according to the specified options.
 * @throws {Error} - Throws an error if a fallback symbol is not found for a key in the replacements object.
 *
 * @example

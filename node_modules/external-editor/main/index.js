...
/**
 * Edits text using an external editor and returns the edited text.
 *
 * @param {string} [text=""] - The initial text to be edited. Defaults to an empty string if not provided.
 * @param {object} fileOptions - Options for editing the file, typically including file path, encoding, etc.
 * @return {string} - The edited text after running the external editor.
 *
 * Example:
 * const editedText = edit("Hello, world!", { filePath: "example.txt" });
 * console.log(editedText); // Outputs the edited content
 */
...
exports.edit = edit;
/**
 * Asynchronously edits text using an external editor and calls the provided callback with the result.
 *
 * @param {string} [text=""] - The initial text to be edited. Defaults to an empty string if not provided.
 * @param {function(Error, any)} callback - A callback function that will be called once the editing is complete or an error occurs.
 * @param {Object} [fileOptions] - Optional options object that can be passed to the external editor for additional configuration.
 *
 * @example
...
var ExternalEditor = /** @class */ (function () {
    /**
     * Initializes an instance of ExternalEditor with optional text and file options.
     *
     * @param {string} [text=""] - The initial content of the editor. Defaults to an empty string.
     * @param {Object} [fileOptions] - An object containing file-specific options.
     */

...
/**
 * Edits the provided text using an external editor and returns the edited text.
 *
 * @param {string} [text=""] - The text to be edited. Defaults to an empty string if not provided.
 * @param {Object} fileOptions - Options for the file being edited.
 * @returns {string} - The edited text after processing by the external editor.
 * @throws {Error} - Throws an error if the editor fails to run or clean up properly.
 *
 * Example:
 * const options = {
 ...
 * };
 * try {
 *   const editedText = edit("Hello, world!", options);
 *   console.log(editedText); // Output may vary based on the editor's modifications
 * } catch (error) {
...
exports.edit = edit;
/**
 * Asynchronously edits text using an external editor.
 *
 * @param {string} [text=""] - The text to be edited. If not provided, it defaults to an empty string.
 * @param {Function} callback - The callback function that will be called once the editing is complete or an error occurs.
 *                             It receives two parameters: err (an Error object if an error occurred, otherwise null) and result (the edited text or null).
 * @param {Object} [fileOptions={}] - Additional options for the file editor.
 *
 * @example
 * editAsync("Hello, world!", function(err, result) {
 *   if (err) {
...
var ExternalEditor = /** @class */ (function () {
    /**
     * Creates an instance of ExternalEditor to manage text editing operations with file options.
     *
     * @constructor
     * @param {string} [text=""] - The initial text content to be edited. Defaults to an empty string if not provided.
     * @param {Object} [fileOptions] - Options related to the file being edited.
     */

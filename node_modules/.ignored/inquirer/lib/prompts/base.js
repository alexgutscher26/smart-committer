...
export default class Prompt {
  ...
  /**
   * Executes a callback function passed as an argument.
   *
  ...
  /**
   * Throw an error indicating that a required parameter is missing.
   *
   * @param {string} name - The name of the missing parameter.
   * @throws {Error} Throws an error if the parameter is not provided.
   */
  ...
  /**
   * Run the provided validation method each time a submit event occurs.
   * @param {Rx.Observable} submit - Observable representing the submit events flow.
   * @return {Object} Object containing two observables: `success` and `error`.
   * @throws {Error} If any of the asynchronous operations fail, an error will be thrown.
   * @example
   * const handleSubmit = (submit) => {
   *   const result = handleSubmitEvents(submit);
   *   result.success.subscribe((data) => console.log('Validation successful:', data));
   *   result.error.subscribe((error) => console.error('Validation failed:', error));
   * };
   */
  ...
  /**
   * Starts rendering the spinner with the provided value and optional bottom content.
   *
   * @param {string} value - The value to display in the spinner.
   * @param {boolean} [bottomContent=false] - Whether to include bottom content in the spinner render.
   */
   ...
   *
   * @return {String} - The generated prompt question string.
   */
  getQuestion() {
    let message =

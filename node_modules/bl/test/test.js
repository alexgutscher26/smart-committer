...
!process.browser && tape('destroy with pipe after read end', function (t) {
  ...
  /**
   * This function is called when an end event occurs.
   *
   * It destroys a buffer object (`bl`) and performs assertions to check that the buffer's internal buffers array and its length are both empty.
   */
  function onEnd () {
    bl.destroy()
...
!process.browser && tape('destroy with pipe while writing to a destination', function (t) {
  ...
  /**
   * Handles the end of a buffer stream by piping it to a destination stream,
   * then destroys both streams after a short delay.
   *
   * @function
   */
  function onEnd () {

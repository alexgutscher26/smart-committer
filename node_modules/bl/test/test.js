...
!process.browser && tape('destroy with pipe after read end', function (t) {
  ...
  /** @function
   * This function is called when an operation or process has ended.
   *
   * It performs the following actions:
   * - Destroys a buffer object `bl` using the method `destroy()`.
   * - Checks if the length of `bl._bufs` array is 0, indicating no remaining buffers.
   * - Asserts that the length of `bl` is 0, ensuring all data has been processed.
   *
   * @throws {Error} If any assertion fails during the process.
   */
  function onEnd () {
    bl.destroy()
...
!process.browser && tape('destroy with pipe while writing to a destination', function (t) {
  ...
  /**
   * Callback function called when an operation ends.
   *
   * This function is responsible for cleaning up resources and performing assertions after the operation has completed.
   */
  function onEnd () {
    bl.pipe(ds)
